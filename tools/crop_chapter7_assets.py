...
CROPS = {
    ...
    "table-07-01": (194, 350, 405, 1175, 1295),  # Table 7.1
    "table-07-02": (194, 375, 1300, 1145, 1618), # Table 7.2 part 1
    "table-07-03": (195, 185, 220, 955, 790),    # Table 7.2 part 2
    "fig-07-01":   (195, 67, 1090, 954, 1690),  # Fig 7.1 LM6361 circuit (excludes eq 7.1)
    ...
    "table-07-04": (202, 330, 415, 1160, 1045),   # Table 7.3 CFA specs
    "fig-07-07":   (203, 185, 180, 1207, 760),    # Fig 7.7 AD844 circuit
    "fig-07-08":   (203, 220, 950, 1090, 1450),  # Fig 7.8 AD844 non-inv amp
    "fig-07-09":   (204, 230, 530, 1080, 1180),  # Fig 7.9 CFA freq response
    "fig-07-10":   (205, 300, 450, 900, 915),   # Fig 7.10 CFA equivalent circuit (full + caption)
    ...
    "table-07-05": (207, 250, 183, 892, 828),  # Table 7.4 AD844 closed-loop
    "fig-07-13":   (208, 365, 670, 1296, 1305),   # Fig 7.13 EL2880C equivalent
    ...
    "table-07-06": (211, 171, 750, 970, 1679),  # Table 7.5 JFET op-amp specs
    "fig-07-17":   (212, 230, 340, 1140, 870),   # Fig 7.17 AD845 circuit
    "table-07-07": (212, 415, 1018, 1090, 1680), # Table 7.6 THD measurements
    ...
    "fig-07-20":   (214, 370, 1050, 1163, 1480),  # Fig 7.20 Settling time (skip heading)
    "fig-07-21":   (215, 90, 600, 1280, 1430),   # Fig 7.21 CS5396 balanced amp
    "fig-07-22":   (215, 620, 1300, 1010, 1640),  # Fig 7.22 Balanced amp gain
    "fig-07-23":   (216, 353, 830, 1141, 1220),   # Fig 7.23 Diff/CM gain concepts (skip eq 7.27 above)

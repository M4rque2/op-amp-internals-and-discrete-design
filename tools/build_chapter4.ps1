...
$chapter = Join-Path $workspace "src\chapter-04"
$sections = Join-Path $chapter "source-sections"
$output = Join-Path $chapter "chapter-04.md"
$cropScript = Join-Path $PSScriptRoot "crop_chapter4_assets.py"
...
if ($LASTEXITCODE -ne 0) {
    throw "Chapter 4 asset cropping failed with exit code $LASTEXITCODE."
}

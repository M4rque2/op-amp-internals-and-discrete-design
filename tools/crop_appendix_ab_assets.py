...
CROPS = {
    ...
    "fig-a-02":   (97, 145, 211, 950, 640),   # 图 A.2 活性领域 (a)(b)
    ...
    "fig-a-06":   (100, 230, 1090, 1200, 1580), # 图 A.6 Ic-Vce Early (a)(b)
    "fig-a-07":   (102, 500, 185, 1045, 620),  # 图 A.7 PN 结电容
    "fig-a-08":   (102, 442, 1176, 1095, 1685), # 图 A.8 Vbe 变化载波
    "fig-a-09":   (103, 200, 805, 1000, 1305),  # 图 A.9 beta-f
    "fig-a-10":   (104, 130, 100, 1200, 330),  # 图 A.10 Hybrid pi 计算
    "fig-a-11":   (105, 230, 130, 1100, 460),  # 图 A.11 Cb/Cjc/Cje-Ic
    "fig-a-12":   (106, 400, 360, 1080, 780),  # 图 A.12 fT-Ic 倾向
    "fig-a-13":   (106, 400, 760, 1020, 1190), # 图 A.13 2SC1815 fT-Ic
    ...
    "fig-b-05":   (111, 294, 798, 840, 1144),  # 图 B.5 频率特性

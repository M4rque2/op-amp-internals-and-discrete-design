...
| 型号 | 电路数 | 最大输入失调电压 /μV | 最大输入偏置电流 /pA | 电源电压 /V | 消耗电流 /mA | GB积 /MHz | 转换速率 /(V/μs) | 输入噪声电压(1kHz)/(nV/√Hz) |
|------|------|------|------|------|------|------|------|------|
...
如图 8.10 所示，LMV751 的 1 kHz 的输入噪声电压密度为 6.5 nV/√Hz，优于 Bi-FET 型运算放大器 LF356 的 \\(12 nV/\sqrt{Hz}\\)，逼近 Bipolar 型的 NE5532 的 \\(5 nV/\sqrt{Hz}\\)。

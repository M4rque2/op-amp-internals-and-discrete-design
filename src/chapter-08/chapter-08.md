...
![图 8.2 AD8532 的简略等效电路](images/fig-08-02.svg)
...
![图 8.4 低失真运算放大器 OPA340/350 的内部等效电路](images/fig-08-04.svg)
...
![图 8.7 依赖 Bipolar 的单一电源运算放大器 OP279 的等效电路](images/fig-08-07.svg)
...
![图 8.15 低输入失调运算放大器 TLC4501/4502 的机能方块图](images/fig-08-15.svg)
...
图 8.16 是 MAXIM 公司的高精度稳压电路，MAX6350 的输出电压，用计数器（Counter）IC 的 74HC390 与低通带滤波器进行精密分压，并在无调整时，可获得 1.000 V±0.2 mV 的电压<sup>[30]</sup>。

![图 8.16 TLC4501 的应用实例——无调整可输出 1.000 V±0.2 mV 的精密电压源](images/fig-08-16.png)

**图 8.16 TLC4501 的应用实例——无调整可输出 1.000 V±0.2 mV 的精密电压源**

MAX6350 是输出电压 = 5.000 V，初期精度 = ±0.02（%），漂移 = 1 ppm/℃（max）的三端子稳压<sup>[31]</sup>。74HC390 为 CMOS 逻辑的（2 进 + 5 进）计数器。其电源端子（接脚 16）有 MAX6350 的输出电压供给。

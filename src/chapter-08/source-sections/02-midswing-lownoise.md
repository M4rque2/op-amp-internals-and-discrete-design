...
如图 8.10 所示，LMV751 的 1 kHz 的输入噪声电压密度为 6.5 nV/√Hz，优于 Bi-FET 型运算放大器 LF356 的 12 nV/√Hz，逼近 Bipolar 型的 NE5532 的 5 nV/√Hz。
...
TLC2201 的输入噪声电压密度（图 8.10），比 LMV751 稍大 8 nV/√Hz（当 1 kHz 时），但电源电压的最大额定，TLC2201 相对于 LMV751 的 5.5 V 却高 16 V。

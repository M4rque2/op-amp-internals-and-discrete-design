...
**表 5.1　具代表性的通用运算放大器的电气特性（\\(T_A=25^\circ\mathrm{C}\\)，\\(V_{CC}=+15\mathrm{V}\\)，\\(V_{EE}=-15\mathrm{V}\\)）**

| 类型名称 | 电路数 | 输入失调电压 /mV typ(max) | 输入偏置电流 /nA typ(max) | 开环增益 /dB typ | \(f_T\) /MHz typ | 转换速率 /(V/μs) typ | 消耗电流 /mA typ | 噪声电压密度 @1 kHz /\\(\mathrm{nV}/\sqrt{\mathrm{Hz}}\\) typ | 噪声电流密度 @1 kHz /\\(\mathrm{pA}/\sqrt{\mathrm{Hz}}\\) typ |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| μA741C | 1 | (1)6 | (80)500 | 106 | 1 | 0.5 | 1.7 | 23 | — |
| RC4558 | 2 | (2)6 | (40)500 | 110 | 3 | 0.8 | 3.6 | 10 | 0.5 |
| NE5532 | 2 | (0.5)4 | (200)800 | 100 | 10 | 9 | 8.0 | 5 | 0.7 |
| LM833 | 2 | (0.3)5 | (300)1000 | 110 | 9 | 7 | 4.0 | 4.5 | 0.5 |
| NJM4560 | 2 | (0.5)6 | (40)500 | 100 | 10 | 4 | 4.3 | 10 | — |
| NJM4580 | 2 | (0.3)3 | (100)500 | 110 | 15 | 5 | 6.0 | — | — |
| TL071C | 1 | (3)10 | (65)200 pA | 106 | 3 | 13 | 1.4 | 18 | 0.01 |
| LF353 | 2 | (5)10 | (50)200 pA | 100 | 4 | 13 | 3.6 | 16 | 0.01 |
| LF356 | 1 | (3)10 | (30)200 pA | 106 | 5 | 12 | 5.0 | 12 | 0.01 |
| μPC814 | 2 | (1)3 | (50)200 pA | 106 | 6 | 25 | 5.0 | 19 | — |
| NJM2082 | 2 | (2)10 | (30)400 pA | 110 | 5 | 20 | 4.0 | 13 | — |
| AD712J | 2 | (0.3)3 | (25)75 pA | 112 | 4 | 20 | 5.0 | 18 | 0.01 |
| OPA604 | 1 | (1)5 | (50) pA− | 100 | 8.5 | 25 | 5.3 | 11 | 0.004 |
| MC34082 | 2 | (1)3 | (60)200 pA | 98 | 8 | 25 | 4.9 | 30 | 0.01 |
...
![图 5.3　TL071/072/074 的内部等效电路（电路的一部分，转载自资料手册，局部删改）](images/fig-05-03.svg)

**图 5.3　TL071/072/074 的内部等效电路（电路的一部分，转载自资料手册，局部删改）**
...
**图 5.5　TL08x 系列的噪声电压特性**

![图 5.6　测试 TL07x 内部的 \\(R_1\\) 与 \\(R_2\\) 值与噪声电压关系的电路](images/fig-05-06.png)

**图 5.6　测试 TL07x 内部的 \\(R_1\\) 与 \\(R_2\\) 值与噪声电压关系的电路**
...
② 只在从属电流源端的发射极连接电阻的非对称电流镜像称为"Widler 型电流镜像"<sup>[12]</sup>，其工作遵从式(2.8)。在制造微小电流源时使用此 Widler 型。
...
![图 5.8　LF353 的内部等效电路（1 电路部分）](images/fig-05-08.svg)

**图 5.8　LF353 的内部等效电路（1 电路部分）**
...
**图 5.12　具代表性的Bi-FET型运算放大器的输出阻抗相对频率的特性（实测）**
...
**图 5.14　具代表性的Bi-FET型通用运算放大器的实测失真率特性**
...
**图 5.15　具代表性的Bi-FET型通用运算放大器的开环增益相对频率的特性（实测）**
...
初级差动元件使用 NPN 型 BJT 的通用运算放大器。输入噪声级小到 5 \\(nV/\\sqrt{\\mathrm{Hz}}\\)，归类于低噪声类型并不见怪。在电源电压=±18 V，600Ω 的负载下可得 \\(10V_{RMS}\\) 的输出电压。

具有宽频带、超低失真率、巨大的相位容限等优点，并具有以音响为中心，活跃广阔的领域。内部电路如图 5.16 所示，简略等效电路则如图 5.17 所示。

![图 5.16　NE5532 的内部等效电路（转载自 TI 公司资料手册）](images/fig-05-16.svg)

**图 5.16　NE5532 的内部等效电路（转载自 TI 公司资料手册）**
...
**图 5.18　当 NE5532 作为电压跟随器使用时，应装入电流限制电阻**
